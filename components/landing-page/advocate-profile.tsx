...
export default function AdvocateProfile() {
  ...
  return (
    <section id="advocate-section" className="backdrop-blur-md relative mb-40 mt-40 min-h-screen flex items-center overflow-hidden bg-transparent">
          ...
          >
            ...
            <div className="relative">
              <div className="relative aspect-3/4 rounded-2xl overflow-hidden border border-slate-800 shadow-2xl group">
                ...
                {/* Bottom Info Card */}
                <div className="absolute bottom-6 left-6 right-6 p-5 bg-slate-900/50 hover:bg-slate-900/80 border border-slate-800 /90 backdrop-blur-xl rounded-xl shadow-2xl">
